...
class UScriptStruct* FMqttMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MqttMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMqttMessage, Z_Construct_UPackage__Script_MqttUtilities(), TEXT("MqttMessage"));
	}
...
template<> MQTTUTILITIES_API UScriptStruct* StaticStruct<FMqttMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttMessage_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttMessage_h_Statics::ScriptStructInfo[] = {
		{ FMqttMessage::StaticStruct, Z_Construct_UScriptStruct_FMqttMessage_Statics::NewStructOps, TEXT("MqttMessage"), &Z_Registration_Info_UScriptStruct_MqttMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMqttMessage), 933023946U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttMessage_h_2052332187(TEXT("/Script/MqttUtilities"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttMessage_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttMessage_h_Statics::ScriptStructInfo),
		nullptr, 0);
