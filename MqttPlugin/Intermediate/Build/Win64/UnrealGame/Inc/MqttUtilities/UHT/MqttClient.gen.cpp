...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Private_Windows_MqttClient_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Private_Windows_MqttClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMqttClient, UMqttClient::StaticClass, TEXT("UMqttClient"), &Z_Registration_Info_UClass_UMqttClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMqttClient), 3948415054U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Private_Windows_MqttClient_h_2510687977(TEXT("/Script/MqttUtilities"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Private_Windows_MqttClient_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Private_Windows_MqttClient_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
