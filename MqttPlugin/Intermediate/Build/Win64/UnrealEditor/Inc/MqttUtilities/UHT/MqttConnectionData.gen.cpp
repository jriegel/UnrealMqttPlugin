...
class UScriptStruct* FMqttConnectionData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MqttConnectionData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMqttConnectionData, Z_Construct_UPackage__Script_MqttUtilities(), TEXT("MqttConnectionData"));
	}
...
template<> MQTTUTILITIES_API UScriptStruct* StaticStruct<FMqttConnectionData>()
{
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics::ScriptStructInfo[] = {
		{ FMqttConnectionData::StaticStruct, Z_Construct_UScriptStruct_FMqttConnectionData_Statics::NewStructOps, TEXT("MqttConnectionData"), &Z_Registration_Info_UScriptStruct_MqttConnectionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMqttConnectionData), 2909490757U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_1827426368(TEXT("/Script/MqttUtilities"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics::ScriptStructInfo),
		nullptr, 0);
