...
template<> MQTTUTILITIES_API UScriptStruct* StaticStruct<FMqttClientConfig>()
{
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttClientConfig_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttClientConfig_h_Statics::ScriptStructInfo[] = {
		{ FMqttClientConfig::StaticStruct, Z_Construct_UScriptStruct_FMqttClientConfig_Statics::NewStructOps, TEXT("MqttClientConfig"), &Z_Registration_Info_UScriptStruct_MqttClientConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMqttClientConfig), 4289693877U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttClientConfig_h_1048474184(TEXT("/Script/MqttUtilities"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttClientConfig_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttClientConfig_h_Statics::ScriptStructInfo),
		nullptr, 0);
